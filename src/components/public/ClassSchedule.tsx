...
import { Calendar, Clock, User, MapPin, ChevronDown, ChevronUp, ChevronLeft, ChevronRight } from 'lucide-react';
import BookingModal from './BookingModal';
import { format, startOfWeek, endOfWeek, eachDayOfInterval, isAfter, isBefore, isSameDay, addDays, subDays, startOfDay, addWeeks, subWeeks } from 'date-fns';
